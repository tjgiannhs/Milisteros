...
class LogicAdapter(Adapter):
    ...
    def __init__(self, chatbot, **kwargs):
        ...
        from GreekBot.greek_response_selection import get_heaviest_response
    ...
    def get_default_response(self):
        '''
        Returns a statement with the default reply text
        '''
        response = Statement(GreekSQLStorageAdapter.defaultReply,"")
        response.id = 1
